...
<section class="flex-grow">
    ...
    <div class="flex my-10 justify-center">
        <form id="addSong" class="max-w-screen-sm bg-white border shadow-2xl border-opacity-20 border-black rounded py-10 xl:px-20 px-5 mx-5 text-parsOrange" method="POST" enctype="multipart/form-data">
            <div class="mb-4">
                <span class="text-3xl">Add your own songs</span>
            </div>
            <div class="my-4">
                <span>Song Title</span>
                <input type="text" name="songtitle" id="" class="w-full bg-gray-600 border-parsOrange border-2 rounded p-1 focus:outline-none">
            </div>
            <div class="my-4">
                <span>Artist Name</span>
                <input type="text" name="artist" id="" class="w-full bg-gray-600 border-parsOrange border-2  rounded p-1 focus:outline-none">
            </div>
            <div class="my-4">
            ...
            <div class="my-4 flex justify-center">
                <input type="hidden" name="route" value="add-music">
                <input type="hidden" name="action" value="create">
                <button type="submit" class="p-2 bg-gray-600 hover:bg-gray-800 hover:text-parsDarkOrange rounded">Add Song</button>
            </div>
        </form>
    </div>
</section>
