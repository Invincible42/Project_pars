        ...
        <div class="flex flex-row justify-between bg-gradient-to-t from-gray-800 to-gray-750 rounded xl:mx-96 mx-5 my-4">
            <div class="flex flex-row overflow-hidden">
                ...
                <div class="self-center justify-self-center mx-2">
                    ...
                    <p class="<?php echo "text-".$playlist['playlistColor']; ?>"><?php echo $playlist['username']; ?></p>
                </div>
            </div>
            <div class="flex items-center text-gray-50">
                <span class="mx-2 hidden lg:inline"><?php echo "Created at: " .date("d-m-Y", strtotime($playlist['created_at'])) ?></span>
            </div>
        </div>
    <?php endforeach ?>
    <?php endif;?>
